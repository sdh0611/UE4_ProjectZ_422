...
bool AZShop::ServerSell_Validate(APawn * Pawn, AZItem * SellItem, int32 Quantity)
{
	return true;
}

void AZShop::ServerSell_Implementation(APawn * Pawn, AZItem * SellItem, int32 Quantity)
{
